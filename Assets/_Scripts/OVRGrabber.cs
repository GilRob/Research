...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected virtual void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
    {
        ...
        //Object sound stuff
        grabbedObject.GetComponentInChildren<AudioSource>().Stop();
    ...
    {
        //MINE
        grabbedObject.GetComponentInChildren<AudioSource>().Play();

        //MY STUFF
        spotLight.transform.position = new Vector3(grabbedObject.transform.position.x, 8.13f, grabbedObject.transform.position.z);
